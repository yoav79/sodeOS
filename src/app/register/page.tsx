...
export default async function RegisterPage({
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 font-sans">
        ...
        <div className="space-y-8 relative z-10 max-w-lg my-auto">
          <div className="space-y-4">
            <h1 className="text-4xl font-extrabold tracking-tight leading-tight">
              Únete a la base de conocimiento de tu empresa
            </h1>
            <p className="text-lg text-slate-300">
              Registra tu cuenta para colaborar, acceder y mantener la documentación viva en tu organización.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 pt-4 border-t border-slate-800">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-white">Cuenta Privada</h4>
                <p className="text-sm text-slate-400">El acceso está estrictamente controlado bajo un código de acceso otorgado por tu organización.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-white">Membresía Seguro</h4>
                <p className="text-sm text-slate-400">Los administradores te asignarán a tus respectivos cerebros una vez activada tu cuenta.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Right Column - Clear Background + RegisterForm Card Container */}
